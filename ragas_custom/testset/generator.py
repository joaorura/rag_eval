...
class TestsetGenerator:
    ...
    def from_llama_index(
        ...
        generator_llm_model = LlamaIndexLLMWrapper(generator_llm, run_config=run_config)
        critic_llm_model = LlamaIndexLLMWrapper(critic_llm, run_config=run_config)
        embeddings_model = LlamaIndexEmbeddingsWrapper(embeddings, run_config=run_config)
        keyphrase_extractor = KeyphraseExtractor(llm=generator_llm_model)
        if docstore is None:
            from langchain.text_splitter import TokenTextSplitter
